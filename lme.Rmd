...
- We used start date as 2020-03-16, because that was the first date that allowed for at least 2 lagged observations in all cities.
...
## LME Log-transformed Case Rate

``` {r}

lmeLog <- 
  lme(fixed = log(case.rate) ~ log(casesTminus1.rate) + log(casesTminus2.rate) + weekend,
