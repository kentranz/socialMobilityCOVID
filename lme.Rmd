...
``` {r forecast7, fig.width=10, fig.height=30}
...
``` {r forecast14, fig.width=10, fig.height=30}
...
``` {r reweighedTest2WksNov.7, fig.width=10, fig.height=40}
...
``` {r reweighedTest2WksNov.14, fig.width=10, fig.height=30}
...
``` {r multiReg7, fig.width=10, fig.height=40}
...
``` {r multiReg14, fig.width=10, fig.height=30}
